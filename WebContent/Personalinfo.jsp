              ...
              <div class="panel panel-success" >
                ...
                <ul class="list-group">
                  ...
                  <div class="container">
                    ...
                    <a href="Reading2.jsp">Reading 3</a><br>
            ...
            <div class="col-md-6">
              <div class="panel panel-info">
                ...
                <div class="panel-body">
                   ...
                   <div class="container">
                   <!--Lịch Sử Thi Button-->
                      <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Lịch Sử Thi</button>
                        ...
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal1">Tạo Lịch Biểu</button>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <table>
                                  ...
                                  <!--Button tạo-->
                                  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal4">Tạo</button>
                                ...
                                <table>
                                    ...
                                    <tr>
                                      ...
                                      <td>2/10/2016</td>
                                          ...
                                          <!--Soạn Tin Nhắn-->
                                   <div class="container">
                                      <a href="TinNhan.jsp" class="btn btn-info" role="button">Soạn</a>
                                   </div>
                                          <!--Soạn Tin nhắn end-->
