...
<body>
	...
	<form id="formthi">
	  <input type="radio" name="gender" value="A">A<br>
...
<form id="formthi">
  <input type="radio" name="gender" value="A" >A. A movie they saw<br>
...
<p align="left">4. Where will the woman be in the afternoon? <br>
  ...
  <input type="radio" name="gender" value="A" >A. At the mall<br>
...
<form id="formthi">
  ...
  <input type="radio" name="gender" value="A" >A. At 6:00<br>
...
<form id="formthi">
  <input type="radio" name="gender" value="A" >A. All<br>
...
<p align="left">7.  Forelli Media Inc. is an internationally ___________ marketing firm noted for its success throughout Europe, <br> East Asia, and the Americas.<br>
  ...
  <input type="radio" name="gender" value="A" >A. Recognized<br>
...
<form id="formthi">
  ...
  <input type="radio" name="gender" value="A" >A. Available<br>
...
<form id="formthi">
  <input type="radio" name="gender" value="A" >A. Invest<br>
...
<p align="left">10.I_______ many way, but a can't do it<br>
  ...
  <input type="radio" name="gender" value="A">A. Vary<br>
...
<form id="formthi">
  ...
  <input type="radio" name="gender" value="A">A. Disappointed<br>
...
<form id="formthi">
  <input type="radio" name="gender" value="A" >A. To advertise their new vacation promotion<br>
...
<p align="left">13. What is NOT true about the bag?<br>
  ...
  <input type="radio" name="gender" value="A" >A.  It is versatile<br>
...
<div class="container">
    ...
    <div class="col-md-4">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <button id="show-btn" class="btn btn-info" onclick="AnSubMit()"  style="width:auto;">Submit</button>
  ...
  <form id="formSubmits" class="modal-content animate"  >
    ...
    <input type="text" placeholder="80/100" name="" required=""><br>
      ...
      <a class="btn btn-success " href="Test5.jsp" type="submit" onclick="XuatDiem()">Review</a> 
