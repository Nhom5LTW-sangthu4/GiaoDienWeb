                    ...
                    <!--cot trái-->
                      <div class="col-md-8">
                        <form id="FormGuiBai" method="post" class="form-horizontal" action="" role="form">
                          <div class="form-group">
                            <label for="tieude" class="col-sm-2">Định Dạng</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="Topic" placeholder="Nhập Loại Đề Thi">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="tentacgia" class="col-sm-2">Tiêu Đề</label>
                            <div class="col-sm-10">
                          ...
                          <button class="btn btn-info" id="UpLoad" style="width:auto;">Up Load</button>
                        </form>
                        <script>
