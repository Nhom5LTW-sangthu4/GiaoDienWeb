...
<br>
From: Personnel<br>
Re: Upcoming vacancies<br>
Date: September 30th<br>
 
This is just to (1)………..everyone that with the decision to open a third branch, we will be needing to increase our<br> staff by at least 30. We will be advertising in the Daily Herald this coming Friday. We would also like to ask (2)….... <br>.staff if they know of any suitable candidates who would be interested in joining the Greyford team. If you know of<br> someone who could make a useful addition to Greyford, please ask them to (3)……….. copies of their resumes.<br> We value your input on our hiring decisions since it is important to us that we maintain the current harmony and<br> level of cooperation we (4)……….. here at Greyford.
 <br>
Thank you.
...
<form>
<p align="left">1.</p>
  <input type="radio" name="gender" value="male" checked>A. Remember<br>
  <input type="radio" name="gender" value="female">B. Reminder<br>
  <input type="radio" name="gender" value="other">C. Remind<br>
  <input type="radio" name="gender" value="other">D. Reconcile<br>
<form>
<p align="left">2.</p>
  <input type="radio" name="gender" value="male" checked>A. Already<br>
  <input type="radio" name="gender" value="female">B.  Existing<br>
  <input type="radio" name="gender" value="other">C. Essential<br>
  <input type="radio" name="gender" value="other">D. Prospective<br>
</form>
<br>
<form>
<p align="left">3.</p>
  <input type="radio" name="gender" value="male" checked>A. Surrender<br>
  <input type="radio" name="gender" value="female">B. Enters<br>
  <input type="radio" name="gender" value="other">C. Submit<br>
  <input type="radio" name="gender" value="other">D. Seal<br>
</form>
<br>
<form>
<p align="left">4.</p>
  <input type="radio" name="gender" value="male" checked>A. Enjoy<br>
  <input type="radio" name="gender" value="female">B. Celebrate<br>
  <input type="radio" name="gender" value="other">C. Live<br>
  <input type="radio" name="gender" value="other">D. Rejoice<br>
</form>
<br>
