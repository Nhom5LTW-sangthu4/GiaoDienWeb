          ...
          <!--cột trái-->
            <div class="col-md-2">
			    ...
			    Last, do some researchs. Check financial websites and up-to-date magazines to get current information on the<br> types of mutual funds available. If you follow these steps, you should be able to find the mutual fund that fits your<br> needs.<br>
			        ...
			        <p align="left">9.</p>
			<form>
			  <input type="radio" name="gender" value="male" checked>A. Invest<br>
			  <input type="radio" name="gender" value="female">B. Ivested<br>
			  <input type="radio" name="gender" value="other">C. Investing<br>
			  <input type="radio" name="gender" value="other">D. Invests<br>
			  </form>
			<form>
			<p align="left">10.<br>
			
			</p>
			  <input type="radio" name="gender" value="male" checked>A. Vary<br>
			  <input type="radio" name="gender" value="female">B. Try<br>
			  <input type="radio" name="gender" value="other">C. Choose<br>
			  <input type="radio" name="gender" value="other">D. Induce<br>
			</form>
			<br>
			<p align="left">11. <br>
			
			</p>
			  <input type="radio" name="gender" value="male" checked>A. Disappointed<br>
			  <input type="radio" name="gender" value="female">B. Pleased<br>
			  <input type="radio" name="gender" value="other">C. Excited<br>
			  <input type="radio" name="gender" value="other">D. Interested<br>
			</form>
			<br>
