          ...
          <!--cột 3-->
            <div class="col-md-3">
              <div class="panel panel-warning">
                <div class="panel-heading">
                  <h3 class="panel-title"><strong>Bài viết nổi bật</strong></h3>
                </div>
                <div class="panel-body">
                  <marquee scrolldelay="6" scrollamount="2" onmouseover="this.stop()"" onmouseout="this.start()" direction="up" height="300" style="height:300px;"  behavior="" direction="">
                    <div class="media">
                      ...
                      <div class="media-body">
                        <h6 class="media-heading"><a href="#">Lịch Khai Giảng</a></h6>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <h6 class="media-heading"><a href="#">Lịch Học</a></h6>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <h6 class="media-heading"><a href="#">Kết Quả Thi</a></h6>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <h6 class="media-heading"><a href="#">Vinh Danh</a></h6>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <h6 class="media-heading"><a href="#">Cảm Nhận</a></h6>
