          ...
          <div class="container">
            <div class="col-md-7">
              <div class="panel panel-info">
                <div class="panel-heading">
                  <h3 class="panel-title"><strong>Đăng Ký Tài Khoản</strong></h3>
                </div>
                <div class="panel-body">
				   <div class="box_register">
				   		<form method="post" action="registration.jsp">
							       <div class="form_item"><span>Full name:</span>
							       <br><input type="text" name="fullname" placeholder="Ex:Trần Công Minh" value=""></div>
								   <div class="form_item"><span>Username</span>
								   <br><input type="text" name="username" placeholder="Ex:Kinect" value=""></div>
						           <div class="form_item"><span>Password</span>
						           <br><input type="password" name="password" value=""></div>
					   	           <div class="form_item"><span>Confirm password</span>
					   	           <br><input type="password" name="cpw"  value=""></div>
