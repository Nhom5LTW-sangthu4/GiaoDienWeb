...
<form>
  <input type="radio" name="gender" value="male" checked>A. To advertise their new vacation promotion<br>
  <input type="radio" name="gender" value="female">B. To increase map sales<br>
  <input type="radio" name="gender" value="other">C. To increase the number of magazine subscribers<br>
  <input type="radio" name="gender" value="other">D. To make weekend trips easier<br>
  </form>
<form>
<p align="left">13. What is NOT true about the bag?<br>

</p>
  <input type="radio" name="gender" value="male" checked>A.  It is versatile<br>
  <input type="radio" name="gender" value="female">B. It has interior pockets.<br>
  <input type="radio" name="gender" value="other">C. It is made of tough material<br>
  <input type="radio" name="gender" value="other">D. It uses zippers<br>
</form>
<br>
...
<div class="container">
    ...
    <div class="col-md-4">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <button class="btn btn-info" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Submit</button>
